...
* @return {boolean}
*/
exports.isPowerOfTwo = function isPowerOfTwo(v)
{
...
if(typeof(performance) != "undefined")
  exports.getTime = performance.now.bind(performance);
else
  exports.getTime = Date.now.bind( Date );
...
* @return {Object}
*/
exports.cloneObject = function(o, t)
{
...
exports.regexMap = function regexMap(regex, text, callback) {
  var result;
...
exports.cloneCanvas = function cloneCanvas(c) {
    var canvas = document.createElement('canvas');
...
exports.wipeObject = function wipeObject(obj)
{
  for (var p in obj)
  {
...
exports.extendClass = function extendClass( target, origin ) {
...
//simple http request
exports.HttpRequest = exports.request = function HttpRequest(url,params, callback, error, options)
{
	var async = true;
...
exports.getFileExtension = function getFileExtension(url)
{
...
exports.loadFileAtlas = function loadFileAtlas(url, callback, sync)
{
...
exports.hexColorToRGBA = (function() {
