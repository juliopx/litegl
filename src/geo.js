...
var CLIP_OVERLAP = GL.CLIP_OVERLAP = 2;
...
var distanceToPlane = GL.distanceToPlane = function distanceToPlane(plane, point)
{
	return vec3.dot(plane,point) + plane[3];
}

var planeBoxOverlap = GL.planeBoxOverlap = function planeBoxOverlap(plane, box)
{
